 ...
 * description:
 */
public class BTMovListFragment extends BaseFragment implements IMoview {
    private RecentUpdate info;
    private int index;
    @BindView(R.id.mvlist)
    TvRecyclerView mRecyclerView;
    private  String pageType;
    private static BTMovListFragment btlistFragment;
    private CommonRecyclerViewAdapter mAdapter;
    private GetRecpresenter getRecpresenter;
    private CenterPresenter centerPresenter;

    public static BTMovListFragment newInstance(String type) {
        btlistFragment = new BTMovListFragment();
